...
The "tigerstats" data frame includes 30 observations on three variables. The three variables are weight, pushups, and position. The weight variable is the weight of each subect in pounds. The pushups variable is the number of pushups completed by each player. The position variable is the type of position played by the player.It is eather line or skill. Line positions requre high body mass and skill positions require a lot of running. 
