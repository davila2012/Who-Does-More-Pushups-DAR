...
**Position** is a factor variable.  
 Weight and pushups are numerical variables.
  ...
  A good way in analyzing these variable to determine whether a line player or a skill player does more pushups would be using a bar chart graph. I will make a bar chart with "position" as the x-axis and "pushups" as its y-axis.   
  A good numerical way to analyze these variables is using
# Results
